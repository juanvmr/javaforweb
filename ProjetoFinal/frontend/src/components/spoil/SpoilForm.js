...
class SpoilForm extends React.Component{
    constructor(props){
        super(props)
        this.state = {id: "", name : ""}
    }
    ...
    handleInsert = ()=>{
        var data = {"name":this.state.name, "quantity":this.state.quantity}
    ...
    render(){
        return <form>
            ...
            <div>
                Quantidade: <input type="number" name="quantity" onChange={this.handleChange}/>
            </div>
            <div>
